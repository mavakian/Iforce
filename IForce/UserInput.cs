...
namespace IForce
{
   public static class UserInput
    {   //SQL
        ...
        public static string DeleteImagesInSearch()
        {
            string sqlqry = $"EXEC  DeleteDocumentPagesSearchResult '{UserInput.Client_ID}' , {UserInput.ResultsID}";
    ...
    public static class WebRequests 
    {
        ...
        public static void startJobRequest(string pathIn, string pathOut,string searchName , string caseName, int cpeid)
        {
